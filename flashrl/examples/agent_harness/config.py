...
class CodingHarnessConfig:
    ...
    @classmethod
    def from_mapping(cls, payload: dict[str, Any] | None) -> "CodingHarnessConfig":
        if payload is None:
            return cls()
    ...
    def with_overrides(self, payload: dict[str, Any] | None) -> "CodingHarnessConfig":
        if not payload:
            return self
